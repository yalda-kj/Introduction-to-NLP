...
# Histogram shows the number of appearance of words in paragraph
word2count = {}
for data in dataset:
...
# Filtering the most frequent one
...
# in each sentence. We do this by creating a 2D matrix in which rows are sentences_NO and
