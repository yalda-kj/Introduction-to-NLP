...
# nltk.sent_tokenize(paragraph) -> find all sentences in the paragraph and return them
sentences = nltk.sent_tokenize(paragraph)

# nltk.word_tokenize(paragraph) -> find all words in the paragraph and return them
